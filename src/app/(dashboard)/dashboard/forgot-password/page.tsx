        ...
        <div className="glass-auth rounded-2xl p-8">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <Link href="/dashboard/login" className="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-500 dark:hover:text-violet-300 transition-colors block">
                ← Back to sign in
              </Link>
            </div>
          ) : (
            <>
              ...
              <p className="text-sm text-zinc-500 text-center mt-6">
                <Link href="/dashboard/login" className="text-violet-600 dark:text-violet-400 hover:text-violet-500 dark:hover:text-violet-300 transition-colors">
                  ← Back to sign in
                </Link>
              </p>
            </>
