...
export function DashboardSidebar({ isOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-60 bg-zinc-950 border-r border-white/[0.06] flex flex-col transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-zinc-500 px-3 py-2">
            Platform
          </p>
          ...
          <div className="pt-4">
            ...
            <Link
              ...
              target="_blank"
              onClick={onClose}
              className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-zinc-400 hover:text-zinc-100 hover:bg-white/[0.04] transition-all"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
        ...
        <div className="p-3 border-t border-white/[0.06]">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-zinc-200 truncate">{session?.tenant.name}</p>
